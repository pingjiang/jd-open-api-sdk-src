...
// Source File Name:   WareAddRequest.java
...
public class WareAddRequest extends AbstractRequest
        implements JdRequest {

    public WareAddRequest() {
    }
    ...
    public Class getResponseClass() {
        return com.jd.open.api.sdk.response.ware.WareAddResponse.class;
    }
