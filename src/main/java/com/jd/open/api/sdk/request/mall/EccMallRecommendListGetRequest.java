...
// Source File Name:   EccMallRecommendListGetRequest.java
...
public class EccMallRecommendListGetRequest extends AbstractRequest
        implements JdRequest {

    public EccMallRecommendListGetRequest() {
    }
    ...
    public String getApiMethod() {
        return "jingdong.ecc.mall.recommend.list.get";
    }
    ...
    public Class getResponseClass() {
        return com.jd.open.api.sdk.response.mall.EccMallRecommendListGetResponse.class;
    }
