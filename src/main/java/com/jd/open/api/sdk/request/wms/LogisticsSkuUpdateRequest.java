...
// Source File Name:   LogisticsSkuUpdateRequest.java
...
public class LogisticsSkuUpdateRequest extends AbstractRequest
        implements JdRequest {

    public LogisticsSkuUpdateRequest() {
    }
    ...
    public String getAppJsonParams()
        ...
        pmap.put("size", size);
        pmap.put("gross_weight", grossWeight);
        pmap.put("net_weight", netWeight);
    ...
    public Class getResponseClass() {
        return com.jd.open.api.sdk.response.wms.LogisticsSkuUpdateResponse.class;
    }
