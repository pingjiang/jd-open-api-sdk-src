...
// Source File Name:   EccMallRecommendAddRequest.java
...
public class EccMallRecommendAddRequest extends AbstractRequest
        implements JdRequest {

    public EccMallRecommendAddRequest() {
    }
    ...
    public String getApiMethod() {
        return "jingdong.ecc.mall.recommend.add";
    }
    ...
    public Class getResponseClass() {
        return com.jd.open.api.sdk.response.mall.EccMallRecommendAddResponse.class;
    }
